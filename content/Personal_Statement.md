...
<div style="border: 2px solid #A3D9A5; background-color: ##D3D3D3; width: 60%; padding: 10px; margin: 20px auto; text-align: center; align-items: center;">
...
저는 피아노를 치고 놀이를 만들었고, 어떨 때는 그림을 그리고 또 어떨 때는 물리학에 빠지기도 하고, 고등학교 때에는 친구와 수학 문제를 같이 풀며 토론하곤 했습니다.  
...
<div style="border: 2px solid #A3D9A5; background-color: #D3D3D3; padding: 10px; display: flex; justify-content: flex-start; align-items: center; white-space: pre;">
...
특히 대학 시절 수강했던  OS나 시큐어 코딩 과목에서는 당시 처음 배우는 개념이었던 Linux, OpenSSL 오픈소스 라이브러리, 멀티 스레딩, 바이너리(ELF 파일 등) 분석을 학습하며, 암호, 코드 인젝션 및 하이재킹 등 보안적인 지식을 융합시켜야 했습니다.  
