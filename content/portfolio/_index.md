...
title_en: "Portfolio"
type: page
description: "문제를 이해하고 실제로 작동하는 구조로 바꾼 대표 작업들."
description_en: "Selected work showing how I turn unclear problems into working structures."
---
...
## 01 · 🌦️ AI Forecast Support
### 낯선 도메인을 기술 방향으로 바꾸기

예보관의 실제 업무와 기존 프로그램을 파악하고, 충분히 정의되지 않았던 요구사항과 AI의 방향을 구체화했습니다.
...
## 03 · 📊 LoL Player Research
### 연구 질문을 반복 가능한 데이터 파이프라인으로 바꾸기
...
## Behind the Work · 🔗 D3F!B Collaboration System
...
**Understand the context → map the structure → design what is needed → make it usable in the real world.**

---

## 01 · 🌦️ AI Forecast Support
### Turning an unfamiliar domain into technical direction

I traced forecasters' workflows and existing tools, then helped turn underdefined needs into clearer requirements and technical direction.
...
## 03 · 📊 LoL Player Research
### Turning a research question into a repeatable data pipeline
...
## 04 · 🎮 Arcanum Nights
### Turning an idea into a design multiple disciplines could build
